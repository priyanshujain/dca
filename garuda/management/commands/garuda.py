...
from garuda.constants import GARUDA_SUFFIX, GARUDA_AST_MAP, \
    GARUDA_IGNORE_FIELDS, GARUDA_CRUD_TEMPLATE, \
    GARUDA_REMOVE_FIELDS, GARUDA_DIR, \
...
def codify_model(app, model_name, model_defnition):
    ...
    return GARUDA_CRUD_TEMPLATE % ctx
